...
- We introduce a small simple OpenMP [example](https://github.com/niravshah241/cpp_profiler_example/tree/matrix_vector_multiplication). Precisely, we introduce dense-Matrix vector multiplication example, where we implement element wise multiplication.
